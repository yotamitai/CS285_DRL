...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        for i in indices[-batch_size:]:
            ob_batch.append(self.obs[i])
            ac_batch.append(self.acs[i])
            re_batch.append(self.rews[i])
            next_ob_batch.append(self.next_obs[i])
            terminal_batch.append(self.terminals[i])
